...
class ClickDataBlock extends SparklineDataBlock
{
    ...
    {
        return (string)__('Clicks');
    }

    public function getScalarValue(): string
    {
        $value = $this->dataProvider->getScalarValue(AnalyticsInterface::ACTION_CLICK, $this->dateFrom, $this->dateTo);
    ...
    public function getSparklineValues(): array
    {
        ...
        return $this->dataProvider->getSparklineValues(
            AnalyticsInterface::ACTION_CLICK,
            $dateExpr,
            $this->dateFrom,
            $this->dateTo
        );   }
