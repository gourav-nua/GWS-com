...
class RevenueDataBlock extends SparklineDataBlock
{
    ...
    {
        $value = $this->dataProvider->getScalarValue(AnalyticsInterface::ACTION_REVENUE, $this->dateFrom, $this->dateTo);

        return $this->dataProvider->currency($value);
    }
    ...
    public function getSparklineValues(): array
    {
        ...
        return $this->dataProvider->getSparklineValues(
            AnalyticsInterface::ACTION_REVENUE,
            $dateExpr,
            $this->dateFrom,
            $this->dateTo
        );
