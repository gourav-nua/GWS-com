...
class ImpressionDataBlock extends SparklineDataBlock
{
    ...
    {
        return (string)__('Impression');
    }

    public function getScalarValue(): string
    {
        $value = $this->dataProvider->getScalarValue(AnalyticsInterface::ACTION_IMPRESSION, $this->dateFrom, $this->dateTo);
    ...
    public function getSparklineValues(): array
    {
        ...
        return $this->dataProvider->getSparklineValues(
            AnalyticsInterface::ACTION_IMPRESSION,
            $dateExpr,
            $this->dateFrom,
            $this->dateTo
        );
